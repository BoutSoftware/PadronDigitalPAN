  ...
  return (
    <div className="flex flex-col px-2 py-4 gap-4 w-full max-w-60 bg-primary text-primary-foreground shadow-lg">
      ...
      >
        ...
        <ListboxSection
          title={"Administrador"}
          classNames={{ heading: "text-primary-foreground opacity-70" }}
          className={!isSuperAdmin ? "hidden" : ""}
        >
          <ListboxItem
            key={"/dashboard/base/users"}
            className="flex items-center gap-2 py-3 px-4 hover:!bg-primary-700 text-primary-foreground"
            startContent={
          ...
          <ListboxItem
            key={"/dashboard/base/directory"}
            className="flex items-center gap-2 py-3 px-4 hover:!bg-primary-700"
            startContent={
