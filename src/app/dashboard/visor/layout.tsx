...
function VisorSidebar() {
  ...
  return (
    <Listbox
      ...
      className={`hidden lg:flex items-center px-2 py-4 max-w-60 bg-primary text-primary-foreground transition-all ${isCaminante && "!hidden"} ${!isOpen && "w-8 p-0 hide-children"}`}
    >
      <ListboxItem
