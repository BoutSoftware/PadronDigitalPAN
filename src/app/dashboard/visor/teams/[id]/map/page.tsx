...
import OfficeMap from "@/components/visor/OfficeMap";
...
export default function ProjectMapPage() {
  ...
  return (
    <div className="flex flex-col flex-1 p-4 pt-0 gap-4 overflow-hidden">
      <div className="flex w-full gap-4 h-full overflow-hidden">
        <OfficeMap showPolygones className="flex flex-1 h-full">
          {
        ...
        <div className="flex-col w-full max-w-xs overflow-hidden hidden lg:flex">
          <Filters />
        </div>
      </div>
    </div>
